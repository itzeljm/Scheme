...
(/)
; expect Error: / takes at least one argument
...
(list '(c u t ) '(i  e p ) '(i e s))
; expect ((c u f) (i e p) (i e s))

(define fifth (lambda (x) (* x x x x x)))
;expect fifth 

(fifth 2)
; expect 32

(define (mult_by_2 x) (* x 2))(mult_by_2 4)
;expect 8

(cdr (car '(5 234 17)))
; expect Error

(begin (define x 5) (fifth x))
; expect 3125

(define awesome_year (print 1995))
; expect 1995
;expect awesome_year

(define y (lambda () 'iwantfood))
;expect y 
...
(begin (display 19) ((lambda (x) (- x 1)) 96))
; expect 1995
...
(define i_want_to_sleep (print 24))
;expect 24
;expect i_want_to_sleep
...
(define (pow base exp)
  (cond ((zero? exp) 1)
    ...
    (else (* base (pow base (quotient exp 2)) (pow base (quotient exp 2))))))
;expect pow
...
(define dolphin (mu (w) (display w)(+ w o o )))
;expect dolphin 

(define starfish (lambda (w o) (dolphin o)))
;expect starfish 

(starfish 1 1)
; expect 13

(define first (mu (a) (+ a c) ))
;expect first

(define second (lambda (a c) (first (* a c))))
;expect second
